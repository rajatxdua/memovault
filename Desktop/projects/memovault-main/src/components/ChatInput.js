...
export default function ChatInput({
  ...
  return (
    <div className="flex flex-col space-y-3">
        ...
        <textarea
          ...
          placeholder={
            freeChatsRemaining > 0 
              ? `Share your thoughts, memories, or ask me anything... (${freeChatsRemaining} free messages left today)`
              : "Share your thoughts, memories, or ask me anything... (10 credits per message)"
          }
      ...
      {/* Helper text with free chat info */}
      <div className={`text-xs text-center ${
        ...
        {freeChatsRemaining > 0 ? (
          <span className="ml-2 text-blue-600 dark:text-blue-400 font-semibold">
            • {freeChatsRemaining} free messages remaining today
          </span>
        ) : (
          <span className="ml-2 text-orange-600 dark:text-orange-400 font-semibold">
            • 10 credits per message after daily limit
          </span>
        )}
      </div>
    </div>
